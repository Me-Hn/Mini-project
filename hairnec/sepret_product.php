...
?>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            ...
            <?php
           $proqry = mysqli_query($mysqli,"select * from product");

            ?>
           <div class="row g-4">
                    <?php while($fuck = mysqli_fetch_assoc($proqry)){ ?>
                        <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                            <div class="product-item text-center border h-100 p-4">
                                <img class="img-fluid mb-4" src="../adminpanel/img/<?php echo $fuck['pro_image'];?>" alt="">
                                <div class="mb-2">
                                ...
                                <a href="#" class="h6 d-inline-block mb-2"><?php echo $fuck['pro_name']; ?></a>
                                <h5 class="text-primary mb-3"><?php echo $fuck['pro_discription']; ?></h5>
                                <h5 class="text-primary mb-3"><?php echo $fuck['pro_price']; ?></h5>
                                <a href="cart.php?proid=<?php echo $fuck['id']?>" class="btn btn-outline-primary px-3">Add To Cart</a>
                            </div>
                        </div>
                    <?php } ?>
                </div>
